...
CREATE TABLE `rooms` (
  ...
  `room_param`           VARCHAR(255)  NOT NULL DEFAULT '',
...
CREATE TABLE `thirteens` (
  ...
  `user_cards`        VARCHAR(1200) NOT NULL DEFAULT '',
  `user_submit_cards` VARCHAR(1200) NOT NULL DEFAULT '',
  `game_results`      VARCHAR(5000) NOT NULL DEFAULT '',
  `status`            INT           NOT NULL DEFAULT '0',
  `created_at`        DATETIME      NOT NULL,
  `updated_at`        DATETIME      NOT NULL,
  PRIMARY KEY (`game_id`),
...
CREATE TABLE `clubs` (
  ...
  `status`        INT          NOT NULL, #'俱乐部状态 -1审核中 1正常 2冻结',
  ...
  `club_coin`     BIGINT       NOT NULL DEFAULT '0',
  `notice`        VARCHAR(200) NOT NULL,
  `setting_param` VARCHAR(200) NOT NULL,
  `created_at`    DATETIME     NOT NULL,
  `updated_at`    DATETIME     NOT NULL,
  PRIMARY KEY (`club_id`),
