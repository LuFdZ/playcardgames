...
INSERT INTO mail_infos VALUES (1102,"退出俱乐部通知", "退出俱乐部通知", "“【%s】”俱乐部已将您移出，如有疑问请联系俱乐部会长。", 1,110, "", now(), now());
...
INSERT INTO mail_infos VALUES (1302,"好友绑定获奖通知", "邀请用户奖励通知", "已成功绑定【%s】作为您的邀请人，符合邀请奖励条件，请领取您的奖励！", 3,110, '[{"MainType":100,"SubType":2,"ItemID":0,"Count":100}]', now(), now());
INSERT INTO mail_infos VALUES (1303,"分享朋友圈奖励通知", "邀请用户奖励通知", "分享成功，请领取您的奖励！", 3,110, '[{"MainType":100,"SubType":2,"ItemID":0,"Count":50}]', now(), now());
